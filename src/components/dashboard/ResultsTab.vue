...
import { 
  CheckCircle2, PenTool, Download, 
  Share2, Clock, BookOpen, Plus 
...
<template>
  <div class="space-y-10 max-w-7xl mx-auto pb-20">
    ...
    <div class="flex justify-start">
       <button @click="router.push('/dashboard')" class="px-8 py-4 bg-blue-600 text-white rounded-2xl font-black flex items-center gap-3 shadow-2xl shadow-blue-200">
